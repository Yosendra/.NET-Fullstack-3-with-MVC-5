    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/bundles/app").Include(
                        "~/Scripts/app/services/attendanceService.js",  // register both these new scripts to bundle
                        "~/Scripts/app/controllers/gigsController.js",  // notice the sequence is important, service first and then controller
                        "~/Scripts/app/app.js"));
