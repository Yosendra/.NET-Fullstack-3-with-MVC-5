...
namespace GigHub.Controllers
{
    ...
    public class GigsController : Controller
    {
        ...
        public ActionResult Attending()
        {
            ...
            //var gigs = GetGigsUserAttending(userId);
            ...
            {
                //UpcomingGigs = gigs,
                UpcomingGigs = GetGigsUserAttending(userId),    // or write like this, more concise
                IsShowActions = User.Identity.IsAuthenticated,
                Heading = "Gigs I'm Going",
                //Attendances = attendances,                    // or write like this, more concise
